...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
    ...
    .setDescription("Seni aramız da görmekten onur ve şeref duyuyoruz, Spunkramman.")
   .setColor("#00ff00")
    .addField("**Sunucu Adresimiz**", "[Tıkla ]()")
    .addField(
      "**Komutlarım İçin",
      "***z!yardım***"
    )
...
client.on("ready", () => {
  client.channels.cache.get('1126224042987376740').join();//SES KANALI IDSI GİRİN
});